package com.example.rabbitmqdemo.demos.config.mqtt.enums;
...
public enum QueueEnum {
     ...
     * 消息通知队列-测试
     */
    QUEUE_OPER_TEST_RECORD("mqtt.test.record.direct", "mqtt.test.record.queue", "mqtt.test.record.routekey");
